...
const criaPainel = (user) => {
    ...
    <div class="content">
      <p>
        <strong class="nomeup">${user.name.first} ${user.name.last}</strong>
        </br>
    ...
    <div class="content columns">
      ...
      <div class="column">
        <div><i class="fas fa-map-marker-alt"></i>${user.location.city}</div>
      </div>
      <div class="column">
        <div><i class="far fa-calendar"></i>${user.dob.date}</div>
      </div>
    </div>
